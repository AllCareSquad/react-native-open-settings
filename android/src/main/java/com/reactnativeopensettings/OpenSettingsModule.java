package com.reactnativeopensettings;
...
public class OpenSettingsModule extends ReactContextBaseJavaModule {
  ...
  /**
   * @brief Open system setting page
   * @param page The page to open
   * @param promise result
   */
  @ReactMethod
  public void open(String page, Promise promise) {
    String target;
    switch (page) {
      case "wifi":
      ...
      case "zen_mode_priority":
        ...
        break;
      default:
        promise.reject(new IllegalArgumentException("not support"));
    }
